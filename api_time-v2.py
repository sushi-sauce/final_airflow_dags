...
def create_job(ti,org, ace, name, command, instance, container):
    token = ti.xcom_pull(task_ids='token')
...
with DAG(
    ...
    t4 = PythonOperator(
            task_id = 'create_job',
            op_kwargs={"org":org_ ,"ace": ace_,"name":name_,"command": command_ ,"container": container_, "instance":instance_},
